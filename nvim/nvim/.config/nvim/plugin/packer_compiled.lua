...
_G.packer_plugins = {
  ...
  ["mason-nvim-dap.nvim"] = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/mason-nvim-dap.nvim",
  ...
  nerdtree = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["nvim-dap-vscode-js"] = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/nvim-dap-vscode-js",
  ...
  ["vscode-js-debug"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/victor/.local/share/nvim/site/pack/packer/opt/vscode-js-debug",
